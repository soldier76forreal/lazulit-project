import Style from "./editOpratorModal.module.css";
...
const EditOpratorModalPortal =(props)=>{
                        ...
                        <div className={props.showModal === true ? `${Style.modalBoarder} ${Style.scaleIn}` : props.showModal === false ? `${Style.modalBoarder} ${Style.scaleOut}` : null} >
                            ...
                            <div className={Style.msg}>
                                    ...
                                    <div className={Style.inputDiv}>
                                        ...
                                        <NormalInput onChange={getPhoneNumberTwo} value={phoneNumberTwo} type='tel'></NormalInput>
                                    </div>
                            </div>
                              
                            <div className={Style.btnsDiv}>
                                <div className={Style.btnDiv}>
                                    <NormalBtn onClick={()=>{props.updateOprator(firstName , lastName , phoneNumberOne , phoneNumberTwo)}}  btnName={'ذخیره'} paddingTop={'5px'} paddingButtom={'5px'} fontSize={'20px'} paddingRight={'25px'} paddingLeft={'25px'} backgroundColor={'#1043A9'} color={'#FFFFFF'} ></NormalBtn>
...
const EditOpratorModal = (props)=>{

    return(
        <Fragment>
            {ReactDom.createPortal(
                <EditOpratorModalPortal updateOprator={props.updateOprator} opratorIdToEdit={props.opratorIdToEdit} closeModal={props.closeModal}  showModal={props.showModal} ></EditOpratorModalPortal>
            ,
...
export default EditOpratorModal;
